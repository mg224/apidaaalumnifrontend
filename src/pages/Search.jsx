  ...
  return (
      <div className="mt-36 bg-gray-50">
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-sm text-gray-900 text-center mb-6">Search our alumni directory! Please allow a minute for the back end to spin up for the first few loads.</p>
